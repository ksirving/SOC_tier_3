...
length(ts) ## 219
ts
ts <- Filter(function(x) grepl("shear", x), ts)
ts <- Filter(function(x) grepl("Seedling", x), ts)
...
write.csv(time_stats_all, "/Users/katieirving/Documents/git/SOC_tier_3/output_data/results/Willow_Seedling_Shear_time_stats_50.csv")
...
td <- Filter(function(x) grepl("shear", x), td)
...
write.csv(total_days_all,"/Users/katieirving/Documents/git/SOC_tier_3/output_data/results/Willow_Seedling_Shear_total_days_50.csv")
