...
write.csv(time_stats_all, "/Users/katieirving/Documents/git/SOC_tier_3/output_data/results/Chub_Adult_Depth_time_stats.csv")
...
write.csv(total_days_all,"/Users/katieirving/Documents/git/SOC_tier_3/output_data/results/Chub_Adult_Depth_total_days.csv")
