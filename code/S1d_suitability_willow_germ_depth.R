...
time_stats_seas[is.na(time_stats_seas)] <- 0
...
write.csv(time_stats_all, "/Users/katieirving/Documents/git/SOC_tier_3/output_data/results/Willow_Germination_Depth_time_stats.csv")
...
total_days_seas[is.na(total_days_seas)] <- 0
...
write.csv(total_days_all,"/Users/katieirving/Documents/git/SOC_tier_3/output_data/results/Willow_Germination_epth_total_days.csv")
