...
for(n in 1: length(h)) {
  ...
  write.csv(prob_stats, paste("output_data/02_", NodeName, "_Willow_Seedling_Depth_prob_stats_current.csv", sep=""))
  ...
  write.csv(Q_Calc, paste("output_data/02_",NodeName,"_Willow_Seedling_Depth_Q_calculation_current.csv", sep=""))
  ...
  write.csv(limits, paste("output_data/02_",NodeName,"_Willow_Seedling_depth_Q_limits_current.csv", sep=""))
  ## percentage time
  ...
  write.csv(melt_time, paste("output_data/02_", NodeName, "_Willow_Seedling_depth_time_stats_current.csv", sep=""))
  ...
  ## save df
  write.csv(melt_days, paste("output_data/02_", NodeName, "_Willow_Seedling_depth_total_days_long_current.csv", sep="") )
...
for(n in 1: length(h)) {
  ...
  write.csv(prob_stats, paste("output_data/02_", NodeName, "_Willow_Seedling_Shear_prob_stats_current.csv", sep=""))
  ...
  write.csv(Q_Calc, paste("output_data/02_",NodeName,"_Willow_Seedling_Shear_Q_calculation_current.csv", sep=""))
  ...
  write.csv(limits, paste("output_data/02_",NodeName,"_Willow_Seedling_shear_Q_limits_current.csv", sep=""))
  ## percentage time
  melt_time<-reshape2::melt(time_statsx, id=c("season", "position", "water_year", "Node"))
  melt_time <- melt_time %>% 
    rename( Probability_Threshold = variable) %>%
    mutate(Species ="Willow", Life_Stage = "Seedling", Hydraulic = "Shear Stress", Node = NodeName)
  head(melt_time)
  write.csv(melt_time, paste("output_data/02_", NodeName, "_Willow_Seedling_shear_time_stats_current.csv", sep=""))
  ...
  ## save df
  write.csv(melt_days, paste("output_data/02_", NodeName, "_Willow_Seedling_shear_total_days_long_current.csv", sep="") )
