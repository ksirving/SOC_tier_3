...
for(n in 1: length(h)) {
  ...
  write.csv(limits, paste("output_data/04_",NodeName,"_Chub_Adult_depth_Q_limits.csv", sep=""))
  ## percentage time
  ...
  write.csv(melt_time, paste("output_data/04_", NodeName, "_Chub_Adult_depth_time_stats.csv", sep=""))
  ...
  ## save df
  write.csv(melt_days, paste("output_data/04_", NodeName, "_Chub_Adult_depth_total_days_long.csv", sep="") )
...
for(n in 1: length(h)) {
  ...
  ## save df
  write.csv(melt_days, paste("output_data/04_", NodeName, "_Chub_Adult_Velocity_total_days_long.csv", sep="") )
