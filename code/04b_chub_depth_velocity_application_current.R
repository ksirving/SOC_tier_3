...
## upload hydraulic data
setwd("input_data/Hydraulics/existing")
...
for(n in 1: length(h)) {
  ...
  hydraul <- read.csv(file=paste("input_data/Hydraulics/existing/", h[n], sep=""))
  # head(hydraul)
  ...
  write.csv(prob_stats, paste("output_data/04_", NodeName, "_Chub_Adult_Depth_prob_stats_current.csv", sep=""))
  ...
  write.csv(Q_Calc, paste("output_data/04_",NodeName,"_Chub_Adult_Depth_Q_calculation_current.csv", sep=""))
  ...
  write.csv(limits, paste("output_data/04_",NodeName,"_Chub_Adult_Depth_Q_limits_current.csv", sep=""))
  ## percentage time
  ...
  write.csv(melt_time, paste("output_data/04_", NodeName, "_Chub_Adult_Depth_time_stats_current.csv", sep=""))
  ...
  ## save df
  write.csv(melt_days, paste("output_data/04_", NodeName, "_Chub_Adult_Depth_total_days_long_current.csv", sep="") )
...
pathname <- "input_data/Hydraulics/existing/"
## upload hydraulic data
setwd("input_data/Hydraulics/existing")
...
for(n in 1: length(h)) {
  ...
  write.csv(prob_stats, paste("output_data/04_", NodeName, "_Chub_Adult_Velocity_prob_stats_current.csv", sep=""))
  ...
  write.csv(Q_Calc, paste("output_data/04_",NodeName,"_Chub_Adult_Velocity_Q_calculation_current.csv", sep=""))
  ...
  write.csv(limits, paste("output_data/04_",NodeName,"_Chub_Adult_Velocity_Q_limits_current.csv", sep=""))
  ## percentage time
  melt_time<-reshape2::melt(time_statsx, id=c("season", "position", "water_year", "Node"))
  melt_time <- melt_time %>% 
    rename( Probability_Threshold = variable) %>%
  ...
  write.csv(melt_time, paste("output_data/04_", NodeName, "_Chub_Adult_Velocity_time_stats_current.csv", sep=""))
  ...
  ## save df
  write.csv(melt_days, paste("output_data/04_", NodeName, "_Chub_Adult_Velocity_total_days_long_current.csv", sep="") )
